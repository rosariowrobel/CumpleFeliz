...
class Contacts {
     ...
     * @category async
     */
    getContactByJid(jid, forceServerSearch = false) {
        let that = this;
        return new Promise((resolve, reject) => {
            if (!jid) {
                ...
                let connectedUser = that.getConnectedUser() ? that.getConnectedUser() : new Contact_1.Contact();
     ...
     * @category async
     */
    getContactById(id, forceServerSearch = false) {
        let that = this;
        return new Promise((resolve, reject) => {
            if (!id) {
    ...
    _onRosterPresenceChanged(presence) {
        ...
        try {
            ...
            if (contact) {
                ...
                let newPresenceRainbow = new PresenceRainbow_1.PresenceRainbow();
                if (on_the_phone) {
                    // contact.presence = "busy";
                    //contact.status = "phone";
                    newPresenceRainbow.presenceLevel = PresenceRainbow_1.PresenceLevel.Busy;
                    newPresenceRainbow.presenceStatus = PresenceRainbow_1.PresenceStatus.Phone;
                }
                else if (manual_invisible) {
                    /*contact.presence = "offline";
                    contact.status = "";
                    // */
                    newPresenceRainbow.presenceLevel = PresenceRainbow_1.PresenceLevel.Invisible;
                    newPresenceRainbow.presenceStatus = PresenceRainbow_1.PresenceStatus.EmptyString;
                }
                else if (manual_dnd) {
                    /*contact.presence = "busy";
                    contact.status = "";
                    ...
                    contact.status = "";
                    // */
                    newPresenceRainbow.presenceLevel = PresenceRainbow_1.PresenceLevel.Away;
                    newPresenceRainbow.presenceStatus = PresenceRainbow_1.PresenceStatus.EmptyString;
                }
                    ...
                    // */
                    newPresenceRainbow.presenceLevel = PresenceRainbow_1.PresenceLevel.Busy;
                    newPresenceRainbow.presenceStatus = PresenceRainbow_1.PresenceStatus.Presentation;
                }
                    ...
                    contact.status = "";
                    // */
                    newPresenceRainbow.presenceLevel = PresenceRainbow_1.PresenceLevel.Online;
                    newPresenceRainbow.presenceStatus = PresenceRainbow_1.PresenceStatus.EmptyString;
                }
                    ...
                    // */
                    newPresenceRainbow.presenceLevel = PresenceRainbow_1.PresenceLevel.Online;
                    newPresenceRainbow.presenceStatus = PresenceRainbow_1.PresenceStatus.Mobile;
                }
                else if (auto_away) {
                    /*contact.presence = "away";
                    contact.status = "";
                    ...
                    contact.status = "";
                    // */
                    newPresenceRainbow.presenceLevel = PresenceRainbow_1.PresenceLevel.Unknown;
                    newPresenceRainbow.presenceStatus = PresenceRainbow_1.PresenceStatus.EmptyString;
                }
