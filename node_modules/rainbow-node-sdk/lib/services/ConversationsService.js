...
class Conversations {
    ...
    attachHandlers() {
        let that = this;
        that._conversationEventHandler = new conversationEventHandler_1.ConversationEventHandler(that._xmpp, that, that._fileStorageService, that._fileServerService, that._bubblesService, that._contactsService);
        that._conversationHandlerToken = [
        ...
        that._conversationHistoryHandler = new conversationHistoryHandler_1.ConversationHistoryHandler(that._xmpp, that, that._contactsService);
        that._conversationHistoryHandlerToken = [
    ...
    unlockWaitingBotConversations(isBotServiceReady) {
        ...
        if (that.botServiceReady) {
            ...
            that.waitingBotConversations.forEach(function (obj, index) {
                return __awaiter(this, void 0, void 0, function* () {
                    let contact = yield that._contactsService.getContactByJid(obj.jid, false);
                    if (contact) {
