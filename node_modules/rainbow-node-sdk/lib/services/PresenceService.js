...
const PresenceRainbow_1 = require("../common/models/PresenceRainbow");
...
class PresenceService {
    constructor(_eventEmitter, _logger, _startConfig) {
        ...
        that._currentPresence = new PresenceRainbow_1.PresenceRainbow(PresenceRainbow_1.PresenceLevel.Online);
        that.RAINBOW_PRESENCE_ONLINE = PresenceRainbow_1.PresenceLevel.Online;
        that.RAINBOW_PRESENCE_DONOTDISTURB = PresenceRainbow_1.PresenceLevel.Dnd;
        that.RAINBOW_PRESENCE_AWAY = PresenceRainbow_1.PresenceLevel.Away;
        that.RAINBOW_PRESENCE_INVISIBLE = PresenceRainbow_1.PresenceLevel.Invisible;
    ...
    start(_options, _core) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                ...
                that._presenceEventHandler = new presenceEventHandler_1.PresenceEventHandler(that._xmpp, _core._contacts);
    ...
    sendInitialPresence() {
        ...
        return new Promise((resolve) => {
            ...
            let presenceRainbow = new PresenceRainbow_1.PresenceRainbow();
    ...
    setPresenceTo(presence) {
        let that = this;
        let presenceRainbow = new PresenceRainbow_1.PresenceRainbow(presence);
        // let show = "online";
        //let status = "";
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (that._useS2S) {
                yield that._s2s.sendS2SPresence(presenceRainbow.toJsonForServer());
            }
            yield that._settings.updateUserSettings({ presence: presenceRainbow.presenceLevel });
        }));
    }
    /**
     * @public
    ...
    */
    ...
    _setUserPresenceStatus(presenceRainbow) {
        let that = this;
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            if (that._useXMPP) {
                that._eventEmitter.once("evt_internal_presencechanged", function fn_onpresencechanged(presence) {
                ...
                yield that._xmpp.setPresence(presenceRainbow.presenceShow, presenceRainbow.presenceStatus);
            }
            if (that._useS2S) {
                ...
                let result = yield that._s2s.sendS2SPresence(presenceRainbow.toJsonForServer());
                that._logger.log("internal", LOG_ID + "(_setUserPresenceStatus) sendS2SPresence result : ", result);
                Utils_1.until(() => { return (presenceChangedReceived === true); }, "Wait for presencechanged after set presence S2S.", 10000).then((untilResult) => {
    ...
    _sendPresenceFromConfiguration() {
        ...
        return new Promise((resolve, reject) => {
            ...
            that._settings.getUserSettings().then(function (settings) {
                ...
                that._setUserPresenceStatus(new PresenceRainbow_1.PresenceRainbow()).then(() => { resolve(); }).catch(() => { reject(error); });
            });
        });
    }
    /**
