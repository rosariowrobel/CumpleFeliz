...
exports.OFFERTYPES = exports.AdminService = void 0;
const ErrorManager_1 = require("../common/ErrorManager");
const Utils_1 = require("../common/Utils");
const LOG_ID = "ADMIN/SVCE - ";
var OFFERTYPES;
(function (OFFERTYPES) {
    OFFERTYPES["FREEMIUM"] = "freemium";
    OFFERTYPES["PREMIUM"] = "premium";
})(OFFERTYPES || (OFFERTYPES = {}));
exports.OFFERTYPES = OFFERTYPES;
let Admin = 
/**
 * @module
 * @name Admin
...
class Admin {
     ...
     * @category async
     */
    createCompany(strName, country, state, offerType) {
        let that = this;
     ...
     */
    retrieveAllOffersOfCompanyById(companyId) {
        let that = this;
        return new Promise(function (resolve, reject) {
            try {
                companyId = companyId ? companyId : that._rest.account.companyId;
                that._rest.retrieveAllCompanyOffers(companyId).then((result) => {
     ...
     * @return {Promise<Array<any>>}
     */
    retrieveAllSubscribtionsOfCompanyById(companyId) {
        let that = this;
        return new Promise(function (resolve, reject) {
            try {
                companyId = companyId ? companyId : that._rest.account.companyId;
                that._rest.retrieveAllCompanySubscriptions(companyId).then((result) => {
                    that._logger.log("debug", LOG_ID + "(retrieveAllOffersOfCompanyById) Successfully get all infos");
                    that._logger.log("internal", LOG_ID + "(retrieveAllOffersOfCompanyById) : result : ", result);
                    resolve(result);
                }).catch(function (err) {
     ...
     * @return {Promise<any>}
     */
    getSubscribtionsOfCompanyByOfferId(offerId, companyId) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            return new Promise(function (resolve, reject) {
                return __awaiter(this, void 0, void 0, function* () {
                    try { //let Offers =  await that.retrieveAllOffersOfCompanyById(companyId);
                        let subscriptions = yield that.retrieveAllSubscribtionsOfCompanyById(companyId);
     ...
     * @return {Promise<any>}
     */
    subscribeCompanyToOfferById(offerId, companyId, maxNumberUsers, autoRenew) {
        let that = this;
        return new Promise(function (resolve, reject) {
            try {
                if (!offerId) {
                ...
                companyId = companyId ? companyId : that._rest.account.companyId;
                that._rest.subscribeCompanyToOffer(companyId, offerId, maxNumberUsers, autoRenew).then((result) => {
     ...
     * @return {Promise<any>}
     */
    subscribeCompanyToDemoOffer(companyId) {
        let that = this;
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                companyId = companyId ? companyId : that._rest.account.companyId;
                let Offers = yield that.retrieveAllOffersOfCompanyById(companyId);
                ...
                for (let offer of Offers) {
                    ...
                    if (offer.name === "Enterprise Demo") {
                        ...
                        resolve(yield that.subscribeCompanyToOfferById(offer.id, companyId, 10, true));
                    }
                }
            }
            catch (err) {
     ...
     * @return {Promise<any>}
     */
    unSubscribeCompanyToDemoOffer(companyId) {
        let that = this;
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                companyId = companyId ? companyId : that._rest.account.companyId;
                ...
                for (let offer of Offers) {
                    ...
                    if (offer.name === "Enterprise Demo") {
                        ...
                        resolve(yield that.unSubscribeCompanyToOfferById(offer.id, companyId));
                    }
                }
            }
            catch (err) {
     ...
     * @return {Promise<any>}
     */
    unSubscribeCompanyToOfferById(offerId, companyId) {
        let that = this;
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                if (!offerId) {
                ...
                companyId = companyId ? companyId : that._rest.account.companyId;
                let subscription = yield that.getSubscribtionsOfCompanyByOfferId(offerId, companyId);
                if (!subscription) {
                    return resolve();
                }
                that._rest.unSubscribeCompanyToSubscription(companyId, subscription.id).then((result) => {
     ...
     * @return {Promise<any>}
     */
    subscribeUserToSubscription(userId, subscriptionId) {
        let that = this;
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                let subscriptionResult = yield that._rest.subscribeUserToSubscription(userId, subscriptionId);
     ...
     * @return {Promise<any>}
     */
    unSubscribeUserToSubscription(userId, subscriptionId) {
        let that = this;
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                let subscriptionResult = yield that._rest.unSubscribeUserToSubscription(userId, subscriptionId);
