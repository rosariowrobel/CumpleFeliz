...
const ConferenceSession_1 = require("../common/models/ConferenceSession");
const ConferencePassCodes_1 = require("../common/models/ConferencePassCodes");
const Conference_1 = require("../common/models/Conference");
 ...
 * @module
 * @name Bubbles
 * @version 1.75.0-dotnet.1 - Documentation generated on 2020/08/19T08:37:35.853Z
 * @public
 * @description
...
class Bubbles {
    constructor(_eventEmitter, _http, _logger, _startConfig) {
        ...
        this._conferenceEndpoints = new ts_generic_collections_linq_1.Dictionary(); // <Conference Id, Conference>
        this._conferencesSessionById = new ts_generic_collections_linq_1.Dictionary(); // <Conference Id, Conference>
        this._linkConferenceAndBubble = new ts_generic_collections_linq_1.Dictionary(); // <Conference Id, Bubble Id>
        this._protocol = null;
        this._host = null;
        this._port = null;
        this.ready = false;
                ...
                if (bubble.conference.scheduled) {
                    ...
                    if (bubble.creator === that._rest.userId) {
                        if (bubble.confEndpoints != null) {
                            ...
                            bubble.confEndpoints.forEach((confEndpoint) => {
                ...
                bubble.confEndpoints.forEach((confEndpoint) => {
                    if (confEndpoint != null) {
                        ...
                        if (that._linkConferenceAndBubble.containsKey(conferenceId)) {
                            ...
                            that._linkConferenceAndBubble.remove((item) => {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (bubbleToRemove) {
                ...
                if (bubbleToRemove.confEndpoints != null) {
                    bubbleToRemove.confEndpoints.forEach((confEndpoint) => {
                        if (confEndpoint != null) {
                            conferenceId = confEndpoint.confEndpointId;
                            if (that._linkConferenceAndBubble.containsKey(conferenceId)) {
                                that._linkConferenceAndBubble.remove((item) => {
     ...
     * @return {Promise<any>}
     */
    getInfoForPublicUrlFromOpenInvite(openInvite) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            let publicUrlObject = {
            ...
            if (openInvite.roomId) {
                publicUrlObject.bubble = yield that.getBubbleById(openInvite.roomId);
            }
            else {
                publicUrlObject.bubbleType = openInvite.roomType;
            }
            if (openInvite.userId) {
                publicUrlObject.contact = yield that._contacts.getContactById(openInvite.userId);
            }
     ...
     * @return {Promise<any>}
     */
    getAllPublicUrlOfBubbles() {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            let allOpenInviteObj = yield that._rest.getAllOpenInviteIdPerRoomOfAUser();
            let allPublicUrl = [];
     ...
     * @return {Promise<any>}
     */
    getAllPublicUrlOfBubblesOfAUser(contact = new Contact_1.Contact()) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            let allOpenInviteObj = yield that._rest.getAllOpenInviteIdPerRoomOfAUser(contact.id);
            let allPublicUrl = [];
            for (let openInvite of allOpenInviteObj) {
                allPublicUrl.push(this.getInfoForPublicUrlFromOpenInvite(openInvite));
            }
     ...
     * @return {Promise<any>}
     */
    getAllPublicUrlOfABubble(bubble) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            if (!bubble) {
            ...
            let allOpenInviteObj = yield that._rest.getAllOpenInviteIdPerRoomOfAUser(undefined, undefined, bubble.id);
            let allPublicUrl = [];
            for (let openInvite of allOpenInviteObj) {
                allPublicUrl.push(this.getInfoForPublicUrlFromOpenInvite(openInvite));
            }
     ...
     * @return {Promise<any>}
     */
    getAllPublicUrlOfABubbleOfAUser(contact, bubble) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            if (!contact) {
            ...
            let allOpenInviteObj = yield that._rest.getAllOpenInviteIdPerRoomOfAUser(contact.id, undefined, bubble.id);
            let allPublicUrl = [];
            for (let openInvite of allOpenInviteObj) {
                allPublicUrl.push(this.getInfoForPublicUrlFromOpenInvite(openInvite));
            }
    ...
    createPublicUrl(bubbleId) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            return that.getPublicURLFromResponseContent(yield that._rest.createPublicUrl(bubbleId));
            /*
    ...
    generateNewPublicUrl(bubbleId) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            return that.getPublicURLFromResponseContent(yield that._rest.generateNewPublicUrl(bubbleId));
            /*
            if (!application.IsCapabilityAvailable(Contact.Capability.BubbleCreate))
        {
            callback?.Invoke(new SdkResult<String>("Current user has not the capability [BubbleCreate]", false));
     ...
     */
    getPublicURLFromResponseContent(content) {
        let that = this;
        let url = null;
     ...
     * @return {string} An url
     */
    registerGuestForAPublicURL(openInviteId, loginEmail, password) {
        let that = this;
        if (!openInviteId) {
        ...
        return new Promise(function (resolve, reject) {
            return __awaiter(this, arguments, void 0, function* () {
                ...
                let guestParam = new RESTService_1.GuestParams(loginEmail, password, null, null, null, null, openInviteId);
                that._rest.registerGuest(guestParam).then(function (joinResult) {
                    resolve(joinResult);
                }).catch(function (err) {
    ...
    getAllActiveBubbles
                ...
                if (!that._profileService.isFeatureEnabled(that._profileService.getFeaturesEnum().WEBRTC_CONFERENCE_ALLOWED) && mediaType !== RESTService_1.MEDIATYPE.WEBRTCSHARINGONLY) {
                ...
                if (confEndPoints.length === 1 && confEndPoints[0].mediaType === RESTService_1.MEDIATYPE.WEBRTC) {
    ...
    getBubbleByConferenceIdFromCache(conferenceId) {
        let result = null;
        let that = this;
        if (that._linkConferenceAndBubble.containsKey(conferenceId)) {
    ...
    /// <param name="conferenceId"><see cref="String"/>ID of the conference</param>
    /// <returns><see cref="Bubble"> - A bubble object or NULL if not found</see></returns>
    getBubbleIdByConferenceIdFromCache(conferenceId) {
        let result = null;
        let that = this;
        if (that._linkConferenceAndBubble.containsKey(conferenceId)) {
    ...
    conferenceGetByIdFromCache(conferenceId) {
        let result = null; // Conference
        let that = this;
    ...
    conferenceGetListFromCache() {
        let that = this;
        let result = new ts_generic_collections_linq_1.List();
    ...
    retrieveConferences(mediaType, scheduled, provisioning) {
        ...
        switch (mediaType) {
            case RESTService_1.MEDIATYPE.PstnAudio:
                return;
            //return this.pstnConferenceService.retrievePstnConferences(scheduled, provisioning);
            case RESTService_1.MEDIATYPE.WEBRTC:
            case RESTService_1.MEDIATYPE.WEBRTCSHARINGONLY:
        ...
        return new Promise((resolve, reject) => {
            ...
            that._rest.retrieveAllConferences(scheduled).then((result) => {
    ...
    updateOrCreateWebConferenceEndpoint(conferenceData) {
        ...
        if (conferenceData.mediaType !== RESTService_1.MEDIATYPE.WEBRTC && conferenceData.mediaType !== RESTService_1.MEDIATYPE.WEBRTCSHARINGONLY) {
            that._logger.log("internalerror", LOG_ID + "(updateOrCreateWebConferenceEndpoint) - wrong mediaType:" + conferenceData.mediaType);
            return null;
        }
        let conference = Conference_1.Conference.createFromData(conferenceData);
        that._conferenceEndpoints[conferenceData.id] = conference;
        if (conference.mediaType === RESTService_1.MEDIATYPE.WEBRTC) {
    ...
    updateWebConferenceInfos(endpoints) {
        ...
        if (that._webrtcConferenceId) {
            this._rest.getRoomByConferenceEndpointId(that._webrtcConferenceId).then((roomData) => __awaiter(this, void 0, void 0, function* () {
                let conferenceRoom = null;
                if (roomData.length) {
                    conferenceRoom = yield that.getBubbleById(roomData[0].id);
                    if (conferenceRoom) {
                    }
                    else {
                        //service.createRoomFromData(roomData[0]);
                        conferenceRoom = yield that.addOrUpdateBubbleToCache(roomData[0]);
    ...
    getWebRtcConfEndpointId() {
        for (let property in this._conferenceEndpoints) {
            if (this._conferenceEndpoints.hasOwnProperty(property) && this._conferenceEndpoints[property].mediaType === RESTService_1.MEDIATYPE.WEBRTC) {
    ...
    getWebRtcSharingOnlyConfEndpointId() {
        for (let property in this._conferenceEndpoints) {
            if (this._conferenceEndpoints.hasOwnProperty(property) && this._conferenceEndpoints[property].mediaType === RESTService_1.MEDIATYPE.WEBRTCSHARINGONLY) {
                return this._conferenceEndpoints[property].id;
            }
        }
        return null;
     ...
     */
    conferenceStart(bubble, conferenceId) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            let bubbleId = null;
            if (bubble) {
            ...
            let mediaType = (conferenceId == that._personalConferenceConfEndpointId) ? RESTService_1.MEDIATYPE.PstnAudio : RESTService_1.MEDIATYPE.WEBRTC;
            if (!conferenceId) {
                return that._rest.conferenceStart(bubble.id, that.getWebRtcConfEndpointId(), RESTService_1.MEDIATYPE.WEBRTC);
            }
            else {
     ...
     */
    conferenceStop(conferenceId) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            // Cf. https://api.openrainbow.org/conference/#api-conference-Stop_conference
            let mediaType = (conferenceId == that._personalConferenceConfEndpointId) ? RESTService_1.MEDIATYPE.PstnAudio : RESTService_1.MEDIATYPE.WEBRTC;
            let roomId = null;
            if (mediaType === RESTService_1.MEDIATYPE.WEBRTC) {
    ...
    conferenceJoin(conferenceId, asModerator, muted, phoneNumber, country) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            /*
    ...
    /// <param name="callback"><see cref="T:Action{SdkResult{Boolean}}"/>Callback fired when the operation is done - True is expected in **Data** member of <see cref="SdkResult{T}"/> if no error occurs</param>
    conferenceMuteOrUnmute(conferenceId, mute) {
        let that = this;
    ...
    /// <param name="mute"><see cref="Boolean"/> True to mute, False to unmute</param>
    /// <param name="callback"><see cref="T:Action{SdkResult{Boolean}}"/>Callback fired when the operation is done - True is expected in **Data** member of <see cref="SdkResult{T}"/> if no error occurs</param>
    conferenceMuteOrUnmutParticipant(conferenceId, participantId, mute) {
        let that = this;
    ...
    /// <param name="callback"><see cref="T:Action{SdkResult{Boolean}}"/>Callback fired when the operation is done - True is expected in **Data** member of <see cref="SdkResult{T}"/> if no error occurs</param>
    conferenceDropParticipant(conferenceId, participantId) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            /*
            if(!application.IsCapabilityAvailable(Contact.Capability.BubbleParticipate))
    ...
    personalConferenceGetBubbleFromCache() {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            ...
            if (that._personalConferenceBubbleId != null) {
                return yield that.getBubbleById(that._personalConferenceBubbleId);
            }
            return null;
        });
    }
    ...
    /// </summary>
    /// <returns><see cref="Bubble"/> - The Bubble which contains the Personal Meeting or null</returns>
    personalConferenceGetBubbleIdFromCache() {
        // if (!String.IsNullOrEmpty(personalConferenceBubbleId))
    ...
    personalConferenceGetPassCodes() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let that = this;
            let result = new ConferencePassCodes_1.ConferencePassCodes();
            let passCodes = yield that._rest.personalConferenceGetPassCodes(that._personalConferenceConfEndpointId);
    ...
    /// <param name="country"><see cref="String"/>Country of the phone number used (ISO 3166-1 alpha3 format) - if not specified used the country of the current user</param>
    /// <param name="callback"><see cref="T:Action{SdkResult{Boolean}}"/>Callback fired when the operation is done - True is expected in **Data** member of <see cref="SdkResult{T}"/> if no error occurs</param>
    personalConferenceJoin(asModerator, muted, phoneNumber, country) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
    ...
    /// <param name="mute"><see cref="Boolean"/> True to mute, False to unmute</param>
    /// <param name="callback"><see cref="T:Action{SdkResult{Boolean}}"/>Callback fired when the operation is done - True is expected in **Data** member of <see cref="SdkResult{T}"/> if no error occurs</param>
    personalConferenceMuteOrUnmute(mute) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
    ...
    /// <param name="callback"><see cref="T:Action{SdkResult{Boolean}}"/>Callback fired when the operation is done - True is expected in **Data** member of <see cref="SdkResult{T}"/> if no error occurs</param>
    personalConferenceLockOrUnlock(toLock) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
    ...
    /// <param name="mute"><see cref="Boolean"/> True to mute, False to unmute</param>
    /// <param name="callback"><see cref="T:Action{SdkResult{Boolean}}"/>Callback fired when the operation is done - True is expected in **Data** member of <see cref="SdkResult{T}"/> if no error occurs</param>
    personalConferenceMuteOrUnmutParticipant(participantId, mute) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
    ...
    /// <param name="participantId"><see cref="String"/> ID of the participant to drop</param>
    /// <param name="callback"><see cref="T:Action{SdkResult{Boolean}}"/>Callback fired when the operation is done - True is expected in **Data** member of <see cref="SdkResult{T}"/> if no error occurs</param>
    personalConferenceDropParticipant(participantId) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (bubble.confEndpoints != null) {
                ...
                bubble.confEndpoints.forEach((confEndpoint) => {
                    ...
                    let conference = new ConferenceSession_1.ConferenceSession();
    ...
    askBubbleForConferenceDetails(bubbleJid) {
        /*
    ...
    askConferenceSnapshot(conferenceId, type) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
    ...
    conferenceModeratorAction(conferenceId, action) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            let mediaType = (conferenceId == that._personalConferenceConfEndpointId) ? RESTService_1.MEDIATYPE.PstnAudio : RESTService_1.MEDIATYPE.WEBRTC;
            if ((mediaType === RESTService_1.MEDIATYPE.WEBRTC) && ((action == "lock") || (action == "unlock"))) {
    ...
    conferenceModeratorActionOnParticipant(conferenceId, participantId, action) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            let mediaType = (conferenceId == that._personalConferenceConfEndpointId) ? RESTService_1.MEDIATYPE.PstnAudio : RESTService_1.MEDIATYPE.WEBRTC;
    ...
    removeConferenceFromCache(conferenceId, deleteLinkWithBubble) {
        let that = this;
        if (that._conferencesSessionById.containsKey(conferenceId)) {
            that._conferencesSessionById.remove((item) => {
