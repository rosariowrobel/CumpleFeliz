...
exports.ConversationHistoryHandler = void 0;
...
let ConversationHistoryHandler = class ConversationHistoryHandler extends GenericHandler {
    constructor(xmppService, conversationService, contactsService) {
        super(xmppService);
                    ...
                    if (conversation) {
                        ...
                        let promise = new Promise((resolve) => {
                            ...
                            if (message) {
                                ...
                                // Create new message
                                let side = that._contactsService.isUserContact(from) ? Message_1.Message.Side.RIGHT : Message_1.Message.Side.LEFT;
                                switch (type) {
                                    case "webrtc":
