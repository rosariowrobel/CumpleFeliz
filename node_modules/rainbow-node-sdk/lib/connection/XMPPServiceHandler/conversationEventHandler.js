...
exports.ConversationEventHandler = void 0;
...
let ConversationEventHandler = class ConversationEventHandler extends GenericHandler {
    constructor(xmppService, conversationService, fileStorageService, fileServerService, bubbleService, contactsService) {
        ...
        let that = this;
        this.onChatMessageReceived = (msg, stanza) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let fromJid = XMPPUtils_1.xu.getBareJIDFromFullJID(stanza.attrs.from);
                let resource = XMPPUtils_1.xu.getResourceFromFullJID(stanza.attrs.from);
                ...
                children.forEach((node) => {
                    switch (node.getName()) {
                            ...
                            if (node.attrs.xmlns === "urn:xmpp:carbons:2") {
                                ...
                                if (forwarded && forwarded.getName() === "forwarded") {
                                    ...
                                    if (message && message.getName() === "message") {
                                        fromJid = XMPPUtils_1.xu.getBareJIDFromFullJID(message.attrs.from);
                                        resource = XMPPUtils_1.xu.getResourceFromFullJID(message.attrs.from);
                        ...
                        case "request":
                            ...
                            //Acknowledge 'read'
                            if (that.xmppService.shouldSendReadReceipt || (messageType === TYPE_GROUPCHAT && XMPPUtils_1.xu.getResourceFromFullJID(stanza.attrs.from) === that.fullJid)) {
                    ...
                    case "conferenceAdd":
                        {
                            ...
                            let bubble = yield that._bubbleService.getBubbleByJid(conferencebubbleJid, true);
                ...
                if (stanza.attrs.type === TYPE_GROUPCHAT) {
                    fromBubbleJid = XMPPUtils_1.xu.getBareJIDFromFullJID(stanza.attrs.from);
                    fromBubbleUserJid = XMPPUtils_1.xu.getResourceFromFullJID(stanza.attrs.from);
                    resource = XMPPUtils_1.xu.getResourceFromFullJID(fromBubbleUserJid);
                }
                if ((messageType === TYPE_GROUPCHAT && fromBubbleUserJid !== that.fullJid) || (messageType === TYPE_CHAT && fromJid !== that.fullJid)) {
                    ...
                    if (stanza.attrs.type === TYPE_GROUPCHAT) {
                        ...
                        data.fromJid = XMPPUtils_1.xu.getRoomJIDFromFullJID(stanza.attrs.from);
                        if (event) {
                            data.event = event;
        ...
        this._onMessageReceived = (conversationId, data) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!conversation) {
                    ...
                    if (data.event === "conferenceAdd") {
                        ...
                        conversation.bubble = yield that._bubbleService.getBubbleByJid(conversationId, true);
                    }
            ...
            try {
                ...
                if (node.attrs.xmlns === "jabber:iq:configuration") {
                    ...
                    if (node.attrs.status) {
                        if (node.attrs.userjid === XMPPUtils_1.xu.getBareJIDFromFullJID(that.fullJid)) {
            ...
            try {
                ...
                if (node.attrs.xmlns === "jabber:iq:configuration") {
                    ...
                    if (conversation) {
                        ...
                        if (action === "create") {
                            let convId = XMPPUtils_1.xu.getBareJIDFromFullJID(node.find("peer").text());
                        ...
                        case "create":
                            {
                                ...
                                yield that._fileStorageService.retrieveAndStoreOneFileDescriptor(fileid, true).then(function (fileDesc) {
