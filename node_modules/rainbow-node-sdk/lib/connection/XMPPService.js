...
exports.NameSpacesLabels = exports.XMPPService = void 0;
...
let XMPPService = class XMPPService {
    constructor(_xmpp, _im, _application, _eventEmitter, _logger, _proxy) {
        ...
        this.handleXMPPConnection = (headers) => {
            ...
            this.xmppClient.on(ERROR_EVENT, function fn_ERROR_EVENT(err) {
            ...
            this.xmppClient.on(DISCONNECT_EVENT, function fn_DISCONNECT_EVENT() {
                return __awaiter(this, void 0, void 0, function* () {
