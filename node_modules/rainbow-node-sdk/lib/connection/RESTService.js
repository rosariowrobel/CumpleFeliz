...
exports.GuestParams = exports.MEDIATYPE = exports.RESTService = void 0;
...
(function (MEDIATYPE) {
    ...
    MEDIATYPE["PstnAudio"] = "pstnAudio";
    MEDIATYPE["WEBRTCSHARINGONLY"] = "webrtcSharingOnly";
})(MEDIATYPE || (MEDIATYPE = {}));
exports.MEDIATYPE = MEDIATYPE;
class GuestParams {
    constructor(_loginEmail = null, _password = null, _temporaryToken = null, _invitationId = null, _joinCompanyInvitationId = null, _joinCompanyLinkId = null, _openInviteId = null, _isInitialized = null, _firstName = null, _lastName = null, _nickName = null, _title = null, _jobTitle = null, _department = null, _emails = null, _phoneNumbers = null, _country = null, _state = null, _language = null, _timezone = null, _visibility = null, _customData = null) {
        let that = this;
...
exports.GuestParams = GuestParams;
...
{name: "GroupTest", comment: "descgroup", isFavorite: true}
     ...
     */
    retrieveWebConferences(mediaType = MEDIATYPE.WEBRTC) {
        let that = this;
    ...
    get_attempt_succeeded_callback(resolve) {
        ...
        if (!that.attempt_succeeded_callback) {
            ...
            that.attempt_succeeded_callback = function fn_attempt_succeeded_callback() {
    ...
    get_attempt_failed_callback(reject) {
        ...
        if (!that.attempt_failed_callback) {
            ...
            that.attempt_failed_callback = function fn_attempt_failed_callback() {
...
// */
     ...
     * @return {Promise<any>}
     */
    getAllOpenInviteIdPerRoomOfAUser(userId, type, roomId) {
        let that = this;
        return new Promise(function (resolve, reject) {
    ...
    ;
    conferenceStart(roomId, conferenceId, mediaType) {
        let that = this;
        return new Promise(function (resolve, reject) {
    ...
    conferenceStop(conferenceId, mediaType, roomId) {
        let that = this;
        return new Promise(function (resolve, reject) {
            let params = {
                mediaType
    ...
    conferenceJoin(conferenceId, mediaType, asModerator, muted, phoneNumber, country) {
        let that = this;
        return new Promise(function (resolve, reject) {
    ...
    personalConferenceRename(personalConferenceConfEndpointId, name) {
        let that = this;
        return new Promise(function (resolve, reject) {
            let param = {
                "name": name
    ...
    conferenceModeratorAction(conferenceId, mediaType, action) {
        let that = this;
        return new Promise(function (resolve, reject) {
    ...
    conferenceModeratorActionOnParticipant(conferenceId, mediaType, participantId, action) {
        let that = this;
        return new Promise(function (resolve, reject) {
            let params = { "option": action, "mediaType": mediaType };
    ...
    retrieveAllCompanyOffers(companyId) {
        let that = this;
        return new Promise(function (resolve, reject) {
    ...
    retrieveAllCompanySubscriptions(companyId) {
        let that = this;
        return new Promise(function (resolve, reject) {
    ...
    subscribeCompanyToOffer(companyId, offerId, maxNumberUsers, autoRenew) {
        let that = this;
    ...
    unSubscribeCompanyToSubscription(companyId, subscriptionId) {
        let that = this;
