...
class NodeSDK {
    ...
    *    },
     ...
     *                          DataStoreType.StoreTwinSide The messages are fully stored.
        ...
        this._core = new Core_1.Core(options);
    }
    /**
     * @public
     * @method start
        ...
        return new Promise(function (resolve, reject) {
            return that._core.start(token).then(function () {
                ...
                if (err) {
                    ...
                    let error = ErrorManager_1.ErrorManager.getErrorManager().UNAUTHORIZED;
                    error.details = err;
    ...
    stop() {
        ...
        return new Promise(function (resolve, reject) {
            return that._core.stop().then(function (result) {
                ...
                Utils_1.setTimeoutPromised(1500).then(() => {
    ...
    stopProcess() {
        ...
        return () => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield self.stop().catch((ee) => {
                    console.log("stopProcess, stop failed : ", ee);
                });
                yield Utils_1.setTimeoutPromised(1000);
     ...
     */
    get DataStoreType() {
        return config_1.DataStoreType;
    }
    static get Appreciation() {
        return Channel_1.Appreciation;
    }
}
